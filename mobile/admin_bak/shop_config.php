...
$url = 'http://service.cub168.com/sms/index.php?certificate_id='.$certi_id.'&sess_id='.$sess_id.'&auth='.$auth.'&ac='.$ac;
...
elseif ($_REQUEST['act'] == 'post')
{
    ...
    $spt = '<script type="text/javascript" src="http://api.cub168.com/record.php?';
