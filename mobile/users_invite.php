...
function user_list()
{
    ...
    if ($result === false)
    {
        ...
        $filter['record_count'] = $GLOBALS['db']->getOne("SELECT COUNT(*) FROM ". $ecs->table('users') ." as eu right join wxch_qr as wq on wq.affiliate = eu.user_id  " . $ex_where." and eu.user_id is not null");
