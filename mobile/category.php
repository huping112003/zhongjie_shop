...
if (!$smarty->is_cached('category.dwt', $cache_id))
{
    ...
    if ($_GET['act'] == 'asynclist') {
        ...
        <div class="proInfo-wrap">
          ...
          <div style="position: absolute;width: 2em;height: 2em;bottom: 3em;right: .5em;cursor: pointer;">
           <img style="width:100%" src="'.$config['site_url'].'themes/luntai/images/addTocart.png" onclick="addToCart('.$vo['goods_id'].')" />
          <div>
        </div>'
                );
            }
