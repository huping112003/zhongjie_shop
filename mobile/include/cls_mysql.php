...
class cls_mysql
{
    ...
    var $max_cache_time = 0; // 最大的缓存时间，以秒为单位 by wang default 300
    ...
    function ErrorMsg($message = '', $sql = '')
    {
        if ($message)
        {
            ...
            //print('<a href="http://faq.cub168.com/?type=mysql&dberrno=2003&dberror=Can%27t%20connect%20to%20MySQL%20server%20on" target="_blank">http://faq.cub168.com/</a>');
        }
        else
        {
            echo "<b>MySQL server error report:";
            print_r($this->error_message);
            //echo "<br /><br /><a href='http://faq.cub168.com/?type=mysql&dberrno=" . $this->error_message[3]['errno'] . "&dberror=" . urlencode($this->error_message[2]['error']) . "' target='_blank'>http://faq.cub168.com/</a>";
        }
