...
<div id="wrapper" class="container">
  <?php echo $this->fetch('library/ur_here_common.lbi'); ?>
  <div class="box" style="padding:20px;">
    ...
    <div class="boxCenterList RelaArticle msg-wrap" align="center" style="padding-top:30px;">
      <p class="msg-content"><?php echo $this->_var['message']['content']; ?></p>
...
?>
          <p class="msg-url"><a href="<?php echo $this->_var['url']; ?>"><?php echo $this->_var['info']; ?></a></p>
