...
elseif ($_REQUEST['step'] == 'done') {
    ...
    if (isset($_POST['rec_id']) && isset($_POST['goods_number'])) {
        ...
        $result['total_real_goods_count'] = $cart_goods['total']['real_goods_count'];
        $result['total_goods_count'] = $cart_goods['total']['goods_count'];
        $result['total_goods_count_str'] = $_LANG['shopping_goods_number'] . ":" . $cart_goods['total']['goods_count'];
...
elseif ($_REQUEST['step'] == 'add_package_to_cart') {
    ...
    $smarty->assign('goods_number', $_LANG['shopping_goods_number'] . ':' . $cart_goods['total']['goods_count']);
